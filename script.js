...
<b>Sepoy</b> Rebellion - Sepoys distrusted the British, which ended up in the Sepoys revolting. A cause was that the rifle cartridges were greased with cow and pig fat, and each was sacred to the Hindus and the Muslims. While to the Sepoys, if their lips touch the grease, they would be “polluted”. Then, at an army post the Sepoys refused to load the cartridges and were charged with mutiny, publicly humiliated, and put in prison. Because of this. the others who were not charged yet got enraged and started killing European men, women, and children. Soon other Indians joined.<br>
